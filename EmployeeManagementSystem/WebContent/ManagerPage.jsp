    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          <h2><c:out value="${row.emp_name}" /></h2>
...
<div class="w3-container w3-card-2 w3-white w3-margin-bottom">
        <h2 class=" w3-padding-16"> <i class="fa fa-search fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>
        <button onclick="document.getElementById('Project Details Pop').style.display='block'"  class="button" id="Project Details">Project Details</button>
</div>
...
<div id="Project Details Pop" class="w3-modal">
  <div class="w3-modal-content w3-animate-zoom">
    <div class="w3-container w3-black w3-display-container">
      <span onclick="document.getElementById('Project Details Pop').style.display='none'" class="w3-button w3-display-topright w3-large">x</span>
...
<td><input list="projectid" name="projectid">
  ...
  <button type="submit" align = center class="w3-button w3-black " onClick() = "">Submit</button> 
  </form>
  
  <c:forEach var="row" items="${result.rows}">
     <tr>
     <td><h1><c:out value="${row.task_name}" /></h1></td>
	 </tr>
	 
	 <tr>
     <td><h1><c:out value="${row.emp_id}" /></h1></td>
	</tr>
	
	<tr>
     <td><h1><c:out value="${row.num_of_hours}" /></h1></td>
	</tr>
	
	<tr>
     <td><h1><c:out value="${row.date}" /></h1></td>
	</tr>
  </c:forEach>
